		...
		const float span_height)
{
	...
	//feet_6lg_v
	((*hex_p).feet_6lg_v)[0][0]=len+loc_v*sin(theta);
	((*hex_p).feet_6lg_v)[0][1]=width1+loc_v*cos(theta);
	((*hex_p).feet_6lg_v)[1][0]=0;
	((*hex_p).feet_6lg_v)[1][1]=width2+loc_v;
	((*hex_p).feet_6lg_v)[2][0]=-len-loc_v*sin(theta);
	((*hex_p).feet_6lg_v)[2][1]=width1+loc_v*cos(theta);
	((*hex_p).feet_6lg_v)[3][0]=len+loc_v*sin(theta);
	((*hex_p).feet_6lg_v)[3][1]=-width1-loc_v*cos(theta);
	((*hex_p).feet_6lg_v)[4][0]=0;
	((*hex_p).feet_6lg_v)[4][1]=-width2-loc_v;
	((*hex_p).feet_6lg_v)[5][0]=-len-loc_v*sin(theta);
	((*hex_p).feet_6lg_v)[5][1]=-width1-loc_v*cos(theta);
	int i;
	for(i=0;i<6;i++)
